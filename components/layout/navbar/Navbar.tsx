...
const Navbar = () => {
  return (
    <nav className="">
      <motion.div
        className="fixed z-50 top-2 sm:top-6 left-0 right-0 flex mx-6 sm:mx-auto dark:border dark:border-border-default shadow-lg shadow-black/10 rounded-full sm:w-fit bg-transparent backdrop-blur-md"
