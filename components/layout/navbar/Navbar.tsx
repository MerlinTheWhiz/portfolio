...
const Navbar = () => {
  return (
    <nav className="fixed z-50 top-5 sm:top-10 left-0 right-0 flex mx-6 sm:mx-auto dark:border dark:border-border-default dark:shadow-none shadow-lg shadow-black/10 rounded-full sm:w-fit bg-background/30 backdrop-blur-md">
